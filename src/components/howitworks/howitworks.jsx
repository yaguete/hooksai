            ...
            <div className="howitworksTable">
                <Box sx={{ width: "100%" }}>
                    ...
                    <TabPanel value={value} index={1}>
                        ...
                        <ul>
                            <li><strong>Integrated</strong> with the most popular design and creation formats: AutoCad, Photoshop, Illustrator, PDF, etc.</li>
                    ...
                    <TabPanel value={value} index={2}>
                        ...
                        <p><strong>Boost the quality</strong> of your print work:
                        <ul>
                            <li>Correct pixelation or blurring in compressed or low resolution images.</li>
